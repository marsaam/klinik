                                                ...
                                                <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">
                                                    ...
                                                    <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">
                                                            ...
                                                            <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                                                <div class="menu-item">
                                                                    <a class="py-3 menu-link" href="../../demo1/dist/pages/profile/overview.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Overview</span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="py-3 menu-link" href="../../demo1/dist/pages/profile/projects.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Projects</span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="py-3 menu-link" href="../../demo1/dist/pages/profile/campaigns.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Campaigns</span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="py-3 menu-link" href="../../demo1/dist/pages/profile/documents.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Documents</span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="py-3 menu-link" href="../../demo1/dist/pages/profile/connections.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Connections</span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="py-3 menu-link" href="../../demo1/dist/pages/profile/activity.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Activity</span>
                                                        ...
                                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">
                                                            ...
                                                            <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                                                <div class="menu-item">
                                                                    <a class="py-3 menu-link" href="../../demo1/dist/pages/projects/list.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">My Projects</span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="py-3 menu-link" href="../../demo1/dist/pages/projects/project.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">View Project</span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="py-3 menu-link" href="../../demo1/dist/pages/projects/targets.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Targets</span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="py-3 menu-link" href="../../demo1/dist/pages/projects/budget.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Budget</span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="py-3 menu-link" href="../../demo1/dist/pages/projects/users.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Users</span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="py-3 menu-link" href="../../demo1/dist/pages/projects/files.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Files</span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="py-3 menu-link" href="../../demo1/dist/pages/projects/activity.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Activity</span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="py-3 menu-link" href="../../demo1/dist/pages/projects/settings.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Settings</span>
                                                        ...
                                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">
                                                            ...
                                                            <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                                                <div class="menu-item">
                                                                    <a class="py-3 menu-link" href="../../demo1/dist/pages/wizards/horizontal.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Horizontal</span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="py-3 menu-link" href="../../demo1/dist/pages/wizards/vertical.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Vertical</span>
                                                        ...
                                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">
                                                            ...
                                                            <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                                                <div class="menu-item">
                                                                    <a class="py-3 menu-link" href="../../demo1/dist/pages/search/horizontal.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Horizontal</span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="py-3 menu-link" href="../../demo1/dist/pages/search/vertical.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Vertical</span>
                                                        ...
                                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">
                                                            ...
                                                            <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                                                <div class="menu-item">
                                                                    <a class="py-3 menu-link" href="../../demo1/dist/pages/company/about.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">About Us</span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="py-3 menu-link" href="../../demo1/dist/pages/company/pricing.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Pricing</span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="py-3 menu-link" href="../../demo1/dist/pages/company/contact.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Contact Us</span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="py-3 menu-link" href="../../demo1/dist/pages/company/team.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Our Team</span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="py-3 menu-link" href="../../demo1/dist/pages/company/licenses.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Licenses</span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="py-3 menu-link" href="../../demo1/dist/pages/company/sitemap.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Sitemap</span>
                                                ...
                                                <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">
                                                    ...
                                                    <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">
                                                            ...
                                                            <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                                                <div class="menu-item">
                                                                    <a class="py-3 menu-link" href="../../demo1/dist/authentication/flows/basic/sign-in.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Sign-in</span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="py-3 menu-link" href="../../demo1/dist/authentication/flows/basic/sign-up.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Sign-up</span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="py-3 menu-link" href="../../demo1/dist/authentication/flows/basic/two-steps.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Two-steps</span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="py-3 menu-link" href="../../demo1/dist/authentication/flows/basic/password-reset.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Password Reset</span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="py-3 menu-link" href="../../demo1/dist/authentication/flows/basic/new-password.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">New Password</span>
                                                        ...
                                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">
                                                            ...
                                                            <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                                                <div class="menu-item">
                                                                    <a class="py-3 menu-link" href="../../demo1/dist/authentication/flows/aside/sign-in.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Sign-in</span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="py-3 menu-link" href="../../demo1/dist/authentication/flows/aside/sign-up.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Sign-up</span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="py-3 menu-link" href="../../demo1/dist/authentication/flows/aside/two-steps.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Two-steps</span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="py-3 menu-link" href="../../demo1/dist/authentication/flows/aside/password-reset.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Password Reset</span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="py-3 menu-link" href="../../demo1/dist/authentication/flows/aside/new-password.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">New Password</span>
                                                        ...
                                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">
                                                            ...
                                                            <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                                                <div class="menu-item">
                                                                    <a class="py-3 menu-link" href="../../demo1/dist/authentication/flows/dark/sign-in.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Sign-in</span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="py-3 menu-link" href="../../demo1/dist/authentication/flows/dark/sign-up.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Sign-up</span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="py-3 menu-link" href="../../demo1/dist/authentication/flows/dark/two-steps.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Two-steps</span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="py-3 menu-link" href="../../demo1/dist/authentication/flows/dark/password-reset.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Password Reset</span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="py-3 menu-link" href="../../demo1/dist/authentication/flows/dark/new-password.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">New Password</span>
                                                ...
                                                <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">
                                                    ...
                                                    <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">
                                                            ...
                                                            <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                                                <div class="menu-item">
                                                                    <a class="py-3 menu-link" href="../../demo1/dist/modals/general/invite-friends.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Invite Friends</span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="py-3 menu-link" href="../../demo1/dist/modals/general/view-users.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">View Users</span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="py-3 menu-link" href="../../demo1/dist/modals/general/upgrade-plan.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Upgrade Plan</span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="py-3 menu-link" href="../../demo1/dist/modals/general/share-earn.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Share &amp; Earn</span>
                                                        ...
                                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">
                                                            ...
                                                            <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                                                <div class="menu-item">
                                                                    <a class="py-3 menu-link" href="../../demo1/dist/modals/forms/new-target.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">New Target</span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="py-3 menu-link" href="../../demo1/dist/modals/forms/new-card.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">New Card</span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="py-3 menu-link" href="../../demo1/dist/modals/forms/new-address.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">New Address</span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="py-3 menu-link" href="../../demo1/dist/modals/forms/create-api-key.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Create API Key</span>
                                                        ...
                                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">
                                                            ...
                                                            <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                                                <div class="menu-item">
                                                                    <a class="py-3 menu-link" href="../../demo1/dist/modals/wizards/two-factor-authentication.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Two Factor Auth</span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="py-3 menu-link" href="../../demo1/dist/modals/wizards/create-app.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Create App</span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="py-3 menu-link" href="../../demo1/dist/modals/wizards/create-account.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Create Account</span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="py-3 menu-link" href="../../demo1/dist/modals/wizards/create-project.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Create Project</span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="py-3 menu-link" href="../../demo1/dist/modals/wizards/offer-a-deal.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Offer a Deal</span>
                                                        ...
                                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">
                                                            ...
                                                            <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                                                <div class="menu-item">
                                                                    <a class="py-3 menu-link" href="../../demo1/dist/modals/search/users.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Users</span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="py-3 menu-link" href="../../demo1/dist/modals/search/select-location.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Select Location</span>
...
-->
                                    ...
                                    <div class="d-flex align-items-center ms-1 ms-lg-3">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px" data-kt-menu="true">
                                            ...
                                            <div class="row g-0">
                                                <!--begin:Item-->
                                                <div class="col-6">
                                                    <a href="../../demo1/dist/pages/projects/budget.html" class="p-6 d-flex flex-column flex-center h-100 bg-hover-light border-end border-bottom">
                                                ...
                                                <!--begin:Item-->
                                                <div class="col-6">
                                                    <a href="../../demo1/dist/pages/projects/settings.html" class="p-6 d-flex flex-column flex-center h-100 bg-hover-light border-bottom">
                                                        <!--begin::Svg Icon | path: icons/duotune/communication/com010.svg-->
                                                        <span class="mb-2 svg-icon svg-icon-3x svg-icon-primary">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                                <path d="M6 8.725C6 8.125 6.4 7.725 7 7.725H14L18 11.725V12.925L22 9.725L12.6 2.225C12.2 1.925 11.7 1.925 11.4 2.225L2 9.725L6 12.925V8.725Z" fill="black" />
                                                ...
                                                <!--begin:Item-->
                                                <div class="col-6">
                                                    <a href="../../demo1/dist/pages/projects/list.html" class="p-6 d-flex flex-column flex-center h-100 bg-hover-light border-end">
                                                        <!--begin::Svg Icon | path: icons/duotune/abstract/abs042.svg-->
                                                        <span class="mb-2 svg-icon svg-icon-3x svg-icon-primary">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                                <path d="M18 21.6C16.6 20.4 9.1 20.3 6.3 21.2C5.7 21.4 5.1 21.2 4.7 20.8L2 18C4.2 15.8 10.8 15.1 15.8 15.8C16.2 18.3 17 20.5 18 21.6ZM18.8 2.8C18.4 2.4 17.8 2.20001 17.2 2.40001C14.4 3.30001 6.9 3.2 5.5 2C6.8 3.3 7.4 5.5 7.7 7.7C9 7.9 10.3 8 11.7 8C15.8 8 19.8 7.2 21.5 5.5L18.8 2.8Z" fill="black" />
                                                ...
                                                <!--begin:Item-->
                                                <div class="col-6">
                                                    <a href="../../demo1/dist/pages/projects/users.html" class="p-6 d-flex flex-column flex-center h-100 bg-hover-light">
                                                        <!--begin::Svg Icon | path: icons/duotune/finance/fin006.svg-->
                                                        <span class="mb-2 svg-icon svg-icon-3x svg-icon-primary">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                                <path opacity="0.3" d="M20 15H4C2.9 15 2 14.1 2 13V7C2 6.4 2.4 6 3 6H21C21.6 6 22 6.4 22 7V13C22 14.1 21.1 15 20 15ZM13 12H11C10.5 12 10 12.4 10 13V16C10 16.5 10.4 17 11 17H13C13.6 17 14 16.6 14 16V13C14 12.4 13.6 12 13 12Z" fill="black" />
                                    ...
                                    <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                                        ...
                                        <div class="py-4 menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold fs-6 w-275px" data-kt-menu="true">
                                            ...
                                            <!--begin::Menu item-->
                                            <div class="px-5 menu-item">
                                                <a href="../../demo1/dist/pages/projects/list.html" class="px-5 menu-link">
                        ...
                        <div id="kt_content_container" class="container-xxl">
                            ...
                            <div class="row gy-5 g-xl-8">
                                ...
                                <div class="col-xxl-4">
                                    ...
                                    <div class="mb-5 card card-xxl-stretch-50 mb-xl-8">
                                        <!--begin::Body-->
                                    ...
                                    <div class="mb-5 card card-xxl-stretch mb-xl-8">
                                        ...
                                        <div class="pt-5 border-0 card-header">
                                            ...
                                            <div class="card-toolbar">
                                                <ul class="nav">
                                                    <li class="nav-item">
                                                        <a class="px-4 nav-link btn btn-sm btn-color-muted btn-active btn-active-dark active fw-bolder me-1" data-bs-toggle="tab" href="#kt_table_widget_5_tab_1">Month</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="px-4 nav-link btn btn-sm btn-color-muted btn-active btn-active-dark fw-bolder me-1" data-bs-toggle="tab" href="#kt_table_widget_5_tab_2">Week</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="px-4 nav-link btn btn-sm btn-color-muted btn-active btn-active-dark fw-bolder" data-bs-toggle="tab" href="#kt_table_widget_5_tab_3">Day</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                ...
                <div class="py-4 footer d-flex flex-lg-column" id="kt_footer">
                    ...
                    <div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
                        ...
                        <ul class="order-1 menu menu-gray-600 menu-hover-primary fw-bold">
                            ...
                            <li class="menu-item">
                                <a href="https://keenthemes.com/support" target="_blank" class="px-2 menu-link">Support</a>
                            </li>
                            <li class="menu-item">
                                    ...
                                    <div class="flex-shrink-0 p-6 border border-dashed rounded notice d-flex bg-light-primary border-primary min-w-lg-600px">
                                        ...
                                        <div class="flex-wrap d-flex flex-stack flex-grow-1 flex-md-nowrap">
                                            ...
                                            <div class="mb-3 mb-md-0 fw-bold">
                                                ...
                                                <div class="text-gray-700 fs-6 pe-7">Login into Metronic Admin Dashboard to make sure the data integrity is OK</div>
                                            </div>
                                            <!--end::Content-->
                                            <!--begin::Action-->
    ...
    <button id="kt_explore_toggle" class="px-5 mt-10 shadow-sm explore-toggle btn btn-sm bg-body btn-color-gray-700 btn-active-primary position-fixed fw-bolder zindex-2 top-50 end-0 transform-90 fs-6 rounded-top-0" title="Explore Metronic" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-trigger="hover">
    ...
    <div id="kt_explore" class="bg-body" data-kt-drawer="true" data-kt-drawer-name="explore" data-kt-drawer-activate="true" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'350px', 'lg': '475px'}" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_explore_toggle" data-kt-drawer-close="#kt_explore_close">
        ...
        <div class="shadow-none card rounded-0 w-100">
            ...
            <div class="card-header" id="kt_explore_header">
                <h3 class="text-gray-700 card-title fw-bolder">Explore Metronic</h3>
                <div class="card-toolbar">
                        ...
                        <div class="mb-0">
                            ...
                            <div class="row g-5">
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="overflow-hidden border border-4 border-gray-200 rounded overlay position-relative">
                                        <div class="overlay-wrapper">
                                            <img src="assets/media/demos/demo10.png" alt="demo" class="opacity-25 w-100" />
                                        </div>
                                        <div class="overlay-layer bg-dark bg-opacity-10">
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="overflow-hidden border border-4 border-gray-200 rounded overlay position-relative">
                                        <div class="overlay-wrapper">
                                            <img src="assets/media/demos/demo12.png" alt="demo" class="opacity-25 w-100" />
                                        </div>
                                        <div class="overlay-layer bg-dark bg-opacity-10">
                                            <div class="px-6 py-4 shadow badge badge-white fw-bold fs-base">Coming soon</div>
                                        </div>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="overflow-hidden border border-4 border-gray-200 rounded overlay position-relative">
                                        <div class="overlay-wrapper">
                                            <img src="assets/media/demos/demo14.png" alt="demo" class="opacity-25 w-100" />
                                        </div>
                                        <div class="overlay-layer bg-dark bg-opacity-10">
                                            <div class="px-6 py-4 shadow badge badge-white fw-bold fs-base">Coming soon</div>
                                        </div>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="overflow-hidden border border-4 border-gray-200 rounded overlay position-relative">
                                        <div class="overlay-wrapper">
                                            <img src="assets/media/demos/demo15.png" alt="demo" class="opacity-25 w-100" />
                                        </div>
                                        <div class="overlay-layer bg-dark bg-opacity-10">
                                            <div class="px-6 py-4 shadow badge badge-white fw-bold fs-base">Coming soon</div>
                                        </div>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="overflow-hidden border border-4 border-gray-200 rounded overlay position-relative">
                                        <div class="overlay-wrapper">
                                            <img src="assets/media/demos/demo16.png" alt="demo" class="opacity-25 w-100" />
                                        </div>
                                        <div class="overlay-layer bg-dark bg-opacity-10">
                                            <div class="px-6 py-4 shadow badge badge-white fw-bold fs-base">Coming soon</div>
                                        </div>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="overflow-hidden border border-4 border-gray-200 rounded overlay position-relative">
                                        <div class="overlay-wrapper">
                                            <img src="assets/media/demos/demo17.png" alt="demo" class="opacity-25 w-100" />
                                        </div>
                                        <div class="overlay-layer bg-dark bg-opacity-10">
                                            <div class="px-6 py-4 shadow badge badge-white fw-bold fs-base">Coming soon</div>
                                        </div>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="overflow-hidden border border-4 border-gray-200 rounded overlay position-relative">
                                        <div class="overlay-wrapper">
                                            <img src="assets/media/demos/demo18.png" alt="demo" class="opacity-25 w-100" />
                                        </div>
                                        <div class="overlay-layer bg-dark bg-opacity-10">
                                            <div class="px-6 py-4 shadow badge badge-white fw-bold fs-base">Coming soon</div>
                                        </div>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="overflow-hidden border border-4 border-gray-200 rounded overlay position-relative">
                                        <div class="overlay-wrapper">
                                            <img src="assets/media/demos/demo19.png" alt="demo" class="opacity-25 w-100" />
                                        </div>
                                        <div class="overlay-layer bg-dark bg-opacity-10">
                                            <div class="px-6 py-4 shadow badge badge-white fw-bold fs-base">Coming soon</div>
                                        </div>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="overflow-hidden border border-4 border-gray-200 rounded overlay position-relative">
                                        <div class="overlay-wrapper">
                                            <img src="assets/media/demos/demo20.png" alt="demo" class="opacity-25 w-100" />
                                        </div>
                                        <div class="overlay-layer bg-dark bg-opacity-10">
                                            <div class="px-6 py-4 shadow badge badge-white fw-bold fs-base">Coming soon</div>
                                        </div>
